...
public class Shuffle<K, V> implements ExceptionReporter {
  ...
  public Shuffle(TaskAttemptID reduceId, JobConf jobConf, FileSystem localFS,
      ...
      Progress copyPhase, Progress mergePhase, Task reduceTask,
  ...
  // public RawKeyValueIterator run(boolean fetchMode) throws IOException,
  // InterruptedException {
  // ReduceCopier reduceCopier = new ReduceCopier(umbilical, job, reporter);
  // if (reduceCopier.)
  //
  // }
  //
