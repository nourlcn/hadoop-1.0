...
public class Merger {
  ...
  public static <K extends Object, V extends Object> RawKeyValueIterator merge(
    ...
    return new MergeQueue<K, V>(conf, fs, inputs, deleteInputs, codec,
        comparator, reporter, null).merge(keyClass, valueClass, mergeFactor, tmpDir,
  ...
  public static <K extends Object, V extends Object> RawKeyValueIterator merge(
      ...
      Counters.Counter writesCounter, Progress mergePhase) throws IOException {
    return new MergeQueue<K, V>(conf, fs, segments, comparator, reporter,
...
//  }
  ...
  public static <K extends Object, V extends Object> void writeFile(
    ...
    long progressBar = conf
        .getLong("mapred.merge.recordsBeforeProgress", 10000);
    long recordCtr = 0;
    while (records.next()) {
  ...
  // //Comment: delete by @nourlcn, split this class.
  ...
  private static class MergeQueue<K extends Object, V extends Object> extends
    ...
    public MergeQueue(Configuration conf, FileSystem fs, Path[] inputs,
        ...
        RawComparator<K> comparator, Progressable reporter, Progress mergePhase) throws IOException {
      this.conf = conf;
      this.fs = fs;
      this.codec = codec;
    ...
    // //add mergePhase into args
    public RawKeyValueIterator merge(Class<K> keyClass, Class<V> valueClass,
        int factor, Path tmpDir, Counters.Counter readsCounter,
        Counters.Counter writesCounter, Progress mergePhase) throws IOException {
    ...
    RawKeyValueIterator merge(Class<K> keyClass, Class<V> valueClass,
        int factor, int inMem, Path tmpDir, Counters.Counter readsCounter,
        Counters.Counter writesCounter, Progress mergePhase) throws IOException {
